...
#include "Vector2D.h"
 ...
 static void BuildGameObjects(std::vector<GameObject*>& game_objects,const int num = 2)
 {
	for (auto count = 0; count < num; ++count)
	{
		 ...
		 std::cin >> point;
		 std::cout << "\n--------------------------------------------------------------" << std::endl;
		 std::cout << "You Entered " << id << " for the gameObjects's ID " << std::endl;
		 std::cout << "You Entered " << point << " for the first gameObject" << std::endl;
		 std::cout << "--------------------------------------------------------------\n" << std::endl;
...
static void CompareGameObjects(GameObject* object1, GameObject* object2)
 {
	...
	std::cout << "Distance between first gameObject to the second gameObject is: " << Vector2D::Distance(object1->GetPosition(), object2->GetPosition()) << std::endl;
	std::cout << "--------------------------------------------------------------\n" << std::endl;
